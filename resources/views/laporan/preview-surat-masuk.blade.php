<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Preview Laporan Surat Masuk') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-800">Preview Laporan Surat Masuk</h3>
                        ...
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('laporan.surat-masuk.download') }}" method="POST" class="inline">
                                @csrf
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-green-700">
                            Ditemukan <strong>{{ $data->count() }}</strong> surat masuk dalam periode yang dipilih.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="text-center mb-8 border-b-2 border-gray-300 pb-6">
                        <div class="flex items-center justify-center mb-4">
                            ...
                            <div class="text-center">
                                <h1 class="text-xl font-bold text-gray-800 mt-4">LAPORAN SURAT MASUK</h1>
                        ...
                        <table class="min-w-full border-collapse border border-gray-300">
                            <thead>
                                <tr class="bg-gray-100">
                                    ...
                                    <th class="border border-gray-300 px-4 py-2 text-left text-xs font-semibold text-gray-700">Tanggal Diterima</th>
                                    <th class="border border-gray-300 px-4 py-2 text-left text-xs font-semibold text-gray-700">Pengirim</th>
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700">{{ $surat->tanggal_diterima->format('d/m/Y') }}</td>
                                    <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700">{{ $surat->pengirim }}</td>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-12 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Tidak ada surat masuk dalam periode yang dipilih.
                    </p>
                    <div class="mt-6">
                        <a href="{{ route('laporan.surat-masuk') }}" 
