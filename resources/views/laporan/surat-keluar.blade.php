            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-800">Buat Laporan Surat Keluar</h3>
                    ...
                    <!-- Form Input Periode -->
                    <form action="{{ route('laporan.surat-keluar.preview') }}" method="POST">
                        @csrf
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-gray-700">
                                        Laporan akan menampilkan surat keluar berdasarkan <strong>tanggal surat</strong> dalam periode yang Anda pilih.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="submit" 
                                    class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline">
