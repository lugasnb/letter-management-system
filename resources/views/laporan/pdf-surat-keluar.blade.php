...
<body>
    ...
    <div class="container">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="width: 12%;">Tanggal Surat</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <span class="status 
                            @if($surat->status == 'draft') status-draft
        ...
        <div class="footer">
            <div class="footer-content">
                <div class="footer-left">
                    <p><strong>Total Surat Keluar:</strong> {{ $data->count() }} surat</p>
        ...
        <div style="text-align: center; padding: 50px 0;">
            <p style="font-size: 14px; color: #666;">Tidak ada data surat keluar dalam periode yang dipilih.</p>
        </div>
        @endif
