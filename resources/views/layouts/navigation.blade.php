            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        <img src="{{ asset('images/logo-kuningan.png') }}" alt="Logo BPKAD" class="h-12 w-auto">
                        <div class="ml-3 hidden sm:block">
                            <div class="text-lg font-bold text-gray-800">BPKAD</div>
                            <div class="text-xs text-gray-600">Kabupaten Kuningan</div>
                        </div>
                    </a>
                </div>
